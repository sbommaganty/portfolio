...
const aboutNavigation = { name: "About", href: "/about" };
const worksNavigation = { name: "Works", href: "/works" };
const projectsNavigation = { name: "Projects", href: "/projects" };
const contactNavigation = { name: "Contact", href: "/contact" };

const innerNavigation = [aboutNavigation, worksNavigation, projectsNavigation];
const outerNavigation = [...innerNavigation, contactNavigation];
